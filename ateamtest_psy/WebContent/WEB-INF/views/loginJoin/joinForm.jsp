...
<form action="join" method="post">
	...
	<div class="wrapper">
		...
		<div class="form">
			...
			<div class="inputfield">
				<label>비밀번호</label> <input type="password" class="input" name="lpwd"
					id="pw1" onmousemove="javascript:pwdChk(this);">
			</div>
			<div class="inputfield">
				<label>비밀번호 재확인</label> <input type="password" class="input"
					id="pw2" placeholder=" 입력하신 비밀번호와 정확히 일치하여야 합니다" onmousemove="javascript:pwdChk(this);">
				<p id="pwchk"></p>
			</div>
			<div class="inputfield">
				<label>전화번호</label>
				...
				<span style="padding: 10px" id="teldash">-</span><input type="text" id="tel2"
					class="input1"><span style="padding: 10px">-</span><input
					type="text" class="input1" id="tel3">
					
					<input type="hidden" id="totaltel" name="lphone" value="">
			...
			<div class="inputfield">
				<label>생년월일</label> <input type="text" class="input2" name="ljumin"
					placeholder="ex) 20220101">
			</div>
			<div class="inputfield">
				<label>이메일</label> <input type="text" class="input1" id="user_email"><span
					style="padding: 10px" id="middle">@</span> <input type="text"
					class="input1" id="email_address">
				<div class="custom_select">
					<select class="input1" id="email_val" style="margin-left: 15px;">
				...
				<input type="hidden" id="totalemail" name="lemail" value="">
...
<script>
	...
	$(function() {
		$('#email_val').change(function() {
			if ($('#email_val').val() == 'directly') {
				$('#email_address').attr("disabled", false);
				$('#email_address').val("");
				$('#email_address').focus();
			} else {
				$('#email_address').val($('#email_val').val());
			}
		})
	});
	...
	function email() {
		...
		console.log(middle)
		console.log(address)
		console.log(email + middle + address)
		if (email != "" && address != "") {
	...
	function totaltel() {
		const totaltel = $("#tel1").val()+$("#teldash").text()+$("#tel2").val()+$("#teldash").text()+$("#tel3").val();
